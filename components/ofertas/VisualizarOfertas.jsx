    ...
    if (user.usertype === "Usuario") {
      return (
        <div>
          <button
            style={{
              boxShadow: "inset 10px 10px 10px rgba(200, 21, 11, 0.315)",
              border: "#246dff",
              marginLeft: "1rem",
              marginTop: "1rem",
            }}
  ...
  return (
    <>
      <div className="card container border-0">
        <div
          id="b"
          className=" container row about-area section-padding "
        ...
        >
          ...
          <div className=" col-lg-6 col-md-12 col-xs-12 info bg-body-tertiary ">
            <div className="site-heading ">
              ...
              >
                Oferta
                <span style={{fontSize:'2rem', fontWeight:'normal'}}>{Ofertas?.title}</span>
              </h2>
            </div>
            ...
            <form className="form p-3">
              <div className="container " style={{ paddingTop: "1rem" }}>
                ...
                >
                  ...
                  <div className="invalid-feedback">
                    Por favor escriba los que necesita
                  </div>
                  <div className="valid-feedback">Listo</div>
